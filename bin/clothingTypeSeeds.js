...
const clothing = [
  ...
  {
    image: [
      "https://pt.burberry.com/sueter-de-la-e-cashmere-com-gola-rule-e-estampa-ekd-p80718561",
    ],
    name: "EKD Wool Cashmere Roll Neck Sweater",
    brand: "Burberry",
    sizes: ["S", "M", "L"],
    type: "Tops",
    gender: "Men",
    description:
      "Knitted with the Equestrian Knight Design, our enduring house code.",
  },
  {
    image: [
